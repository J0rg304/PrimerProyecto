...
public class Ejercicio13 {
    public static void main(String[] args) {
        ...
        int billetes500 = euros / 500; // En el resto queda lo demas
        int auxiliar = euros % 500; // en el resto queda lo demas de 200, de 100..
        int billetes200 = auxiliar / 200;
        auxiliar = auxiliar % 200; // Aqui en este resto esta lo que queda de 50, de 20
        ...
        auxiliar = auxiliar % 5;
        int monedass2 = auxiliar / 2;
        int monedas1 = auxiliar % 2;
        System.out.println(euros + " euros " + billetes500 + " billetes  de 500 " + billetes200 + " billetes de 200 " + billetes100 + " billetes de 100 " + billetes50 + " billetes de 50 " + billetes20 + "billetes de 20 " + billetes10 + "billetes de 10 " + billetes5 + " billetes de 5 " + monedass2 + " monedas2 " + monedas1 + " monedas1");
    }
}
